...
export function AddPropertyForm({ companyId }: { companyId: string }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button size="sm" />}>Add property</DialogTrigger>
      <DialogContent className="sm:max-w-md">
        ...
        <form action={formAction} className="flex max-h-[70vh] flex-col gap-4 overflow-y-auto">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input id="category" name="category" placeholder="e.g. Deluxe, Standard" />
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="totalRooms">Total rooms</Label>
              <Input id="totalRooms" name="totalRooms" type="number" min={0} />
            </div>
            <div className="flex flex-col gap-1.5">
          ...
          <DialogFooter>
            ...
            <SubmitButton label="Add property" pendingLabel="Adding..." />
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
